...
export default function Navbar() {
  ...
  const userDashboardPath = role && dashboardPath[role]
            ...
            <div className="flex items-center gap-3">
              {userDashboardPath ? (
                <Link
                  ...
                  className="flex items-center gap-2 rounded-full bg-slate-100/80 px-3 py-1.5 text-xs font-semibold text-slate-700 ring-1 ring-slate-200 transition-all hover:bg-blue-50 hover:text-blue-700 hover:ring-blue-600/20 active:scale-95"
                >
            ...
            {user ? (
              <div className="flex flex-col gap-3">
                {userDashboardPath ? (
                  <Link
                    to={userDashboardPath}
                    className="flex items-center gap-2 rounded-xl px-2 py-1.5 text-sm font-semibold text-slate-700 transition-all hover:bg-blue-50 hover:text-blue-700 active:scale-95"
                  >
