  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      <div className="card flex items-center gap-5 p-6">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-ink-950">{company.name}</h1>
      ...
      <h2 className="mb-4 mt-10 text-lg font-semibold text-ink-950">ការងារបើកបច្ចុប្បន្ន · Open Roles</h2>
      {jobs === null ? (
        <Loader />
      ) : jobs.length === 0 ? (
